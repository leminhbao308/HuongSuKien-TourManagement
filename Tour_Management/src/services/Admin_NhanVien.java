...
public class Admin_NhanVien extends JPanel implements ActionListener {
	...
	private class FrameAddNhanVien extends JFrame implements ActionListener, FocusListener, KeyListener {
		...
		private javax.swing.JRadioButton radNam;
		private javax.swing.JRadioButton radNu;
		private ButtonGroup btnGroupGenderAdd;
		private javax.swing.JTextField txtDiaChi;
		private javax.swing.JTextField txtEmail;
		private javax.swing.JTextField txtMaNV;
		...
		private void init() {
			...
			radNam = new javax.swing.JRadioButton();
			radNu = new javax.swing.JRadioButton();
			btnGroupGenderAdd = new ButtonGroup();
			btnGroupGenderAdd.add(radNam);
			btnGroupGenderAdd.add(radNu);
			pnNgaySinh = new javax.swing.JPanel();
...
//	    txtMaNV.setEditable(false);
	...
	private void addOneRowToTable(NhanVien nv, DefaultTableModel model) {
		...
		model.addRow(new Object[] { nv.getMaNhanVien(), nv.getTenNhanVien(), gioiTinh, nv.getNgaySinh(), nv.getDiaChi(),
				nv.getEmail(), nv.getSoDienThoai(), nv.getChucVu() });
	}
}
