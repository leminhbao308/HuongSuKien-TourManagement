...
public class Employee_VeTour extends JPanel implements ActionListener {
	...
	btnInfo.setToolTipText("Xem thông tin vé tour (Ctrl + I)");
	btnInfo.setEnabled(false);

	btnPrint.setText("In Vé Tour");
	btnPrint.setToolTipText("In vé tour (Ctrl + I)");
	...
	public FrameInfoVeTour(String[] data) {
	    this.setTitle("SE Tourist - Thông Tin Vé Tour");
