 ...
 * 
 *         ĐỊNH DẠNG - KHỞI TẠO FILE FILE ĐỂ XUẤT HỢP ĐỒNG CŨNG NHƯ TICKET
 */
public class PDFCreator {
    /**
     * Chức năng tạo vé tour
     * 
     * @param veTour thông tin vé cần tạo
     * @param path   đường dẫn lưu vé tour
     * @throws DocumentException bắt lỗi không tạo được file .pdf
     * @throws IOException       bắt lỗi đọc ghi file .pdf
     */
     ...
     * Khởi tạo hợp đồng
     * 
     * @param hopDong thông tin hợp đồng
     * @param path    đường dẫn lưu file hợp đồng
     * @throws DocumentException bắt lỗi không tạo được file .pdf
     * @throws IOException       bắt lỗi đọc ghi file .pdf
     */
	...
	cell = new PdfPCell(new Phrase("Nơi Khởi Hành", tableHeader));
	cell.setBorder(Rectangle.BOTTOM);
	table.addCell(cell);
