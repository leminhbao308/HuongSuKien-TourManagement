...
/**
 * Button tÃ¹y chá»‰nh vá»›i thiáº¿t káº¿ vÃ  hiá»‡u á»©ng thiáº¿t láº­p sáºµn
 * 
 * @author LeMinhBao
...
public class HeaderButton extends JButton {
	...
	/**
	 * Khá»Ÿi táº¡o má»™t Button tÃ¹y chá»‰nh vá»›i má»™t sá»‘ thÃ´ng sá»‘ mong
	 * muá»‘n
	 * 
	 * @param title           TiÃªu Ä‘á»� trÃªn Button
	 * @param backgroundColor MÃ u ná»�n máº·c Ä‘á»‹nh cá»§a Button
	 * @param textColor       MÃ u chá»¯ máº·c Ä‘á»‹nh cá»§a Button
	 */
